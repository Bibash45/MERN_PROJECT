        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
          ...
          <div className=" flex items-center space-x-6 rtl:space-x-reverse">
            <div className="relative">
              ...
              <div className="absolute -top-1 -right-1 h-5 w-5 bg-red-900 text-white rounded-full text-center flex items-center justify-center p-2">
                {cartData.length}
              </div>
            </div>
            ...
            <ul className="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
              ...
              <li onClick={() => handleClick("features")}>
                <Link
                  to="#"
                  className={`${
                    currentState === "features" ? "font-bold" : "text-gray-900"
                  } dark:text-white hover:underline`}
                >
                  Features
                </Link>
